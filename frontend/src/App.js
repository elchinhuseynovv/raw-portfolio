      ...
      <div className="text-center px-4 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-[8rem] md:text-[12rem] lg:text-[16rem] xl:text-[20rem] font-black text-white/70 leading-none tracking-tight -mt-8"
          >
            STORYTELLING
          </motion.h2>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-white/60 text-lg md:text-xl mt-12 max-w-2xl mx-auto font-light tracking-wide"
        >
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <div className="text-white/40 text-sm tracking-[0.3em] font-light">
            Scroll For GOOSEBUMPS CONTENT
          </div>
          <motion.div 
            className="w-1 h-8 bg-white/30 mx-auto mt-4"
            animate={{ y: [0, 10, 0] }}
    ...
    >
      <div className="text-center px-4">
        <motion.div
          ...
          className="relative"
        >
          <h1 className="text-[8rem] md:text-[12rem] lg:text-[16rem] xl:text-[24rem] font-black text-white/60 leading-none tracking-tight">
            EMMY
          </h1>
          <motion.div
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            <div className="text-white/50 text-xl tracking-[0.2em] font-light">
              AWARD-WINNING
            </div>
          </motion.div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
        ...
        >
          <div className="relative group cursor-pointer">
            ...
            <motion.div
              className="absolute top-4 right-4 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white/30 transition-all duration-300"
...
const Footer = () => {
  ...
  return (
    <footer 
      ref={ref}
      className="min-h-screen bg-gradient-to-b from-[#481500] to-[#1a0a00] flex items-center justify-center relative"
    >
      <div className="text-center px-4">
        <motion.div
          initial={{ opacity: 0, y: 100 }}
        ...
        >
          ...
          <h2 className="text-[4rem] md:text-[6rem] lg:text-[8rem] font-black text-white/40 leading-none tracking-tight -mt-8">
            STORYTELLING
          </h2>
          <h3 className="text-[2rem] md:text-[3rem] lg:text-[4rem] font-black text-white/30 leading-none tracking-tight -mt-4">
            SYSTEM™
          </h3>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-white/50 text-lg max-w-3xl mx-auto mt-12 font-light leading-relaxed"
        >
        ...
        >
          <div className="text-white/30 text-sm tracking-[0.3em] font-light">
            500+ BILLION VIEWS • 25+ YEARS EXPERIENCE
          </div>
          <div className="text-white/20 text-xs tracking-widest font-light">
