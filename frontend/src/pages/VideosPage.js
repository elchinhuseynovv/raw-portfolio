    ...
    >
      <div className="max-w-7xl mx-auto px-8 text-center">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-black/30 rounded-2xl group-hover:bg-black/20 transition-all duration-500 flex items-center justify-center">
            <motion.div
              className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white/30 transition-all duration-300"
        ...
        <motion.p
          ...
          className="text-white/50 text-lg mt-8 font-light tracking-wide"
        >
...
const PortfolioGrid = () => {
  ...
  return (
    <section 
      ref={ref}
      className="min-h-screen bg-gradient-to-b from-[#D1A887] to-[#C8956D] py-20"
    >
            ...
            >
              <div className="relative overflow-hidden rounded-2xl">
                ...
                <div className="absolute top-4 right-4">
                  <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-white text-xs font-light tracking-wider">
                    {item.category}
                  </span>
                </div>
                <motion.div
                  className="absolute bottom-4 right-4 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white/30 transition-all duration-300"
              ...
              <div className="mt-4">
                <h3 className="text-xl font-bold text-white/80 mb-2">{item.title}</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {clients.map((client, index) => (
            <motion.div
              ...
              className="text-white/40 text-sm font-light tracking-wider hover:text-white/60 transition-colors cursor-pointer p-4"
            >
              {client}
            </motion.div>
          ))}
